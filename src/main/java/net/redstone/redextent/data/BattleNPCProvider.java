...
public class BattleNPCProvider extends PixelmonNPCProvider {
    ...
    private void createBlueDragonGymLeader() {
        ...
        // 使用新的 addGymLeader 简化版方法
        addGymLeader(
                "blue_dragon_leader",          // 文件名
                "蓝龙",                        // NPC名称
                "神兽道馆馆主·蓝龙",           // 标题翻译键
                "欢迎来到神兽道馆！我是馆主蓝龙。准备好面对传说中的宝可梦了吗？", // 问候语翻译键
                "不可思议！你竟然战胜了我的神兽队伍！这是神兽徽章，你值得拥有！", // 胜利消息翻译键
                "神兽的力量果然不是那么容易挑战的，继续努力吧！", // 失败消息翻译键
    ...
    private void createFireLegendaryTrainer() {
        ...
        addGymLeader(
                ...
                "炎煌",                        // NPC名称
                "火焰神兽训练家·炎煌",         // 标题翻译键
                "我是火焰神兽训练家炎煌！让火焰净化一切吧！", // 问候语翻译键
                "你的实力让我印象深刻！继续前进吧！", // 胜利消息翻译键
                "火焰的力量果然还是最强的！",   // 失败消息翻译键
                fireTeam,                      // 神兽队伍配置
                5000.0,                        // 奖励金钱
                List.of(                       // 奖励物品
    ...
    private void createWaterLegendaryTrainer() {
        ...
        addGymLeader(
                ...
                "海澜",                        // NPC名称
                "水系神兽训练家·海澜",         // 标题翻译键
                "我是水系神兽训练家海澜！感受大海的力量吧！", // 问候语翻译键
                "你的实力如海洋般深不可测！继续前进吧！", // 胜利消息翻译键
                "大海的力量是无穷无尽的！",     // 失败消息翻译键
                waterTeam,                     // 神兽队伍配置
                5000.0,                        // 奖励金钱
                List.of(                       // 奖励物品
    ...
    private void createElectricLegendaryTrainer() {
        ...
        addGymLeader(
                ...
                "雷霆",                        // NPC名称
                "电系神兽训练家·雷霆",         // 标题翻译键
                "我是电系神兽训练家雷霆！准备好被电击了吗？", // 问候语翻译键
                "你的实力如闪电般耀眼！继续前进吧！", // 胜利消息翻译键
                "电力的力量无人能挡！",        // 失败消息翻译键
                electricTeam,                  // 神兽队伍配置
                5000.0,                        // 奖励金钱
                List.of(                       // 奖励物品
    ...
    private void createDragonLegendaryTrainer() {
        ...
        addGymLeader(
                ...
                "龙啸",                        // NPC名称
                "龙系神兽训练家·龙啸",         // 标题翻译键
                "我是龙系神兽训练家龙啸！感受龙之怒吧！", // 问候语翻译键
                "你的实力如同传说中的龙骑士！继续前进吧！", // 胜利消息翻译键
                "龙族的力量永远是最强的！",     // 失败消息翻译键
                dragonTeam,                    // 神兽队伍配置
                5000.0,                        // 奖励金钱
                List.of(                       // 奖励物品
